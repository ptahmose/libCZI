...
bool CDimensionChannelInfo::TryGetPockelCellSetting(int* pocketcellsetting) /*override*/
{
...
bool CDimensionChannelLaserScanInfo::TryGetLaserAttenuatorMeas(double* lastAttenuatorMeas) /*override*/
{
	return this->laserAttenuatorMeas.TryGet(lastAttenuatorMeas);
}
